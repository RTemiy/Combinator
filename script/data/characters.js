export const CHARACTERS = [
  ...
  { icon: 'assets/icons/characters/simple_man_04.png', name: 'Пожилой мужчина', desc: 'Мудрый и спокойный, он ценит порядок и проверенные временем вещи.' },
  ...
  { icon: 'assets/icons/characters/simple_woman_04.png', name: 'Пожилая женщина', desc: 'Добрая и рассудительная, она находит радость в простых повседневных делах.' },
];
