const ITEM_CATEGORIES = {
  stationery: {
    ...
    items: [
      ...
      { level: 5, icon: '🎒', name: 'Школьный рюкзак', desc: 'Вмещает в себя кучу тетрадей, учебников и пенал.' },
      { level: 6, icon: '📚', name: 'Стопка учебников', desc: 'Сборник древних и современных знаний по всем наукам.' },
      { level: 7, icon: '🧙', name: 'Энциклопедия магии', desc: 'Легендарный фолиант. Высшая точка развития канцелярии!' }
    ]
  },
  flowers: {
    name: 'Цветы',
    ...
    items: [
      ...
      { level: 4, icon: '🌸', name: 'Цветок сакуры', desc: 'Нежное розовое соцветие, напоминающее о быстротечной весне.' },
  ...
  sweets: {
    ...
    items: [
      ...
      { level: 2, icon: '🍫', name: 'Плитка шоколада', desc: 'Настоящий темный шоколад, отлично поднимает настроение.' },
      { level: 3, icon: '🍩', name: 'Глазированный пончик', desc: 'Пышное сладкое тесто с разноцветной посыпкой сверху.' },
      { level: 4, icon: '🍦', name: 'Рожок мороженого', desc: 'Хрустящая вафля и шарик тающего ванильного пломбира.' },
      { level: 5, icon: '🍧', name: 'Ледяной десерт', desc: 'Фруктовый лед с сиропом — спасение в самую сильную жару.' },
      { level: 6, icon: '🍰', name: 'Кусочек торта', desc: 'Бисквитные коржи, пропитанные нежным ягодным кремом.' },
      { level: 7, icon: '🎂', name: 'Праздничный торт', desc: 'Шедевр кулинарии со свечами. Пик кондитерского искусства!' }
    ]
  },
  accessories: {
    name: 'Аксессуары',
    color: '#e0aaff',
    items: [
      { level: 1, icon: '🪙', name: 'Древняя монета', desc: 'Старинная мелочь со стершимся от времени чеканом.' },
      { level: 2, icon: '📿', name: 'Амулет на шнурке', desc: 'Простое повседневное украшение из деревянных бусин.' },
      { level: 3, icon: '👓', name: 'Стильные очки', desc: 'Модная оправа. Придает владельцу крайне умный вид.' },
      { level: 4, icon: '💍', name: 'Серебряное кольцо', desc: 'Изящное ювелирное изделие, поблескивающее на свету.' },
      { level: 5, icon: '👑', name: 'Золотая корона', desc: 'Символ королевской власти, украшенный редким бархатом.' },
      { level: 6, icon: '💎', name: 'Ограненный алмаз', desc: 'Редчайший драгоценный камень безупречной чистоты и огранки.' },
      { level: 7, icon: '🏆', name: 'Кубок чемпиона', desc: 'Абсолютная награда из чистого золота для победителей!' }
    ]
  },
  gadgets: {
    name: 'Гаджеты и ПК',
    color: '#4cc9f0',
    items: [
      { level: 1, icon: '💾', name: 'Дискета', desc: 'Винтажный носитель информации объемом всего 1.44 МБ.' },
      { level: 2, icon: '🔌', name: 'Кабель питания', desc: 'Медный проводник энергии для запуска сложных электросистем.' },
      { level: 3, icon: '🖱️', name: 'Оптическая мышь', desc: 'Эргономичный контроллер с чувствительным лазерным сенсором.' },
      { level: 4, icon: '🎧', name: 'Студийные наушники', desc: 'Профессиональный звук и отличная пассивная шумоизоляция.' },
      { level: 5, icon: '📱', name: 'Смартфон', desc: 'Карманный мини-компьютер с поддержкой любых приложений.' },
      { level: 6, icon: '💻', name: 'Игровой ноутбук', desc: 'Мощное мобильное железо в компактном корпусе для работы и игр.' },
      { level: 7, icon: '🖥️', name: 'Рабочая станция', desc: 'Топовый ПК с огромным монитором. Абсолютная мечта разработчика!' }
    ]
  },
  fastfood: {
    name: 'Фастфуд',
    color: '#ff8a5c',
    items: [
      { level: 1, icon: '🥤', name: 'Газировка со льдом', desc: 'Освежающий шипучий напиток. Отлично утоляет жажду.' },
      { level: 2, icon: '🍟', name: 'Картошка фри', desc: 'Золотистые ломтики картофеля, хрустящие снаружи и мягкие внутри.' },
      { level: 3, icon: '🫔', name: 'Острый твистер', desc: 'Сочная начинка с соусом, завернутая в пшеничную лепешку.' },
      { level: 4, icon: '🍕', name: 'Кусок пиццы', desc: 'Ароматный треугольник с тянущимся сыром моцарелла и пепперони.' },
      { level: 5, icon: '🍔', name: 'Сочный бургер', desc: 'Мягкая булочка с кунжутом, мясная котлета, салат и фирменный соус.' },
      { level: 6, icon: '🍗', name: 'Ведерко крылышек', desc: 'Острые куриные крылышки в хрустящей панировке на большую компанию.' },
      { level: 7, icon: '🍱', name: 'Большой комбо-обед', desc: 'Полный набор сытной еды на любой вкус. Настоящий пир быстрого приготовления!' }
    ]
  }
};
...
const GENERATOR_BOXES = {
  ...
  accessories: { icon: '👑', name: 'Сундук с сокровищами', desc: 'Кованый ларь с ценными украшениями.' },
